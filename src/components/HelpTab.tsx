...
const FAQ = [
  ...
  },
  {
    ...
    a: "На базовом тарифе число одновременных устройств = 1 + докупленные слоты. Если лимит исчерпан: «Профиль» → отвяжите устройство или «Сбросить все слоты» (раз в 24 ч). Можно докупить +1 устройство в профиле.",
  },
  {
