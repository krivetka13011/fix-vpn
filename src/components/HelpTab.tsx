...
const FAQ = [
  ...
  },
  {
    ...
    a: "На пробном периоде и базовом тарифе одновременно работает 1 устройство (1 IP в панели). Телефон и ПК часто имеют разные IP даже в одной Wi‑Fi сети. Чтобы сменить устройство: «Профиль» → «Сбросить привязки», затем подключитесь снова.",
  },
  {
