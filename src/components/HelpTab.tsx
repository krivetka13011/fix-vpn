...
const FAQ = [
  ...
  },
  {
    ...
    a: "На пробном периоде и базовом тарифе одновременно работает 1 устройство (1 IP в панели). Чтобы сменить телефон: «Профиль» → «Сбросить привязку устройств». Следующий сброс — через 24 часа.",
  },
  {
