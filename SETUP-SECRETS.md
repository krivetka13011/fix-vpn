...
**Live URL** — на странице [последнего зелёного деплоя](https://github.com/krivetka13011/fix-vpn/actions) вверху блок **FIX VPN — Live URL** (или шаг *Resolve deployment URL* → строка `Live URL:`).
